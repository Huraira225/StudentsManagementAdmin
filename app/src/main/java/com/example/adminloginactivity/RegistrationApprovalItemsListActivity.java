...
public class RegistrationApprovalItemsListActivity extends ArrayAdapter<RegisterUsers> {
    ...
    public RegistrationApprovalItemsListActivity(Activity context, List<RegisterUsers> Users) {
